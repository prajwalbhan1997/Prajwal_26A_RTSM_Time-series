...
```{r}
#Arima manuplation
arma13 = arima(MARICO.NS_return, order = c(5, 0, 4)); arma13
...
Objective: To fit an ARIMA(5, 0, 4) model to the daily returns ('MARICO.NS_return') of MARICO.NS stock and generate forecasts.
...
Implication:
The ARIMA(5, 0, 4) model is fitted to the historical daily returns of MARICO.NS stock, providing insights into the underlying patterns. The generated forecast can be used for future predictions, and the plot visually represents the model's performance.
...
Ljung-Box Test for Autocorrelation on Residuals:
  - X-squared statistic: 2.1708e-08
  - Degrees of freedom: 1
  - p-value: 0.9999

Implication:
The Ljung-Box test indicates no significant autocorrelation in the residuals of the ARIMA(5, 0, 4) model. The high p-value (0.9999) suggests that there is no evidence against the null hypothesis of no autocorrelation.
...
ARCH Test on Squared Residuals:
                        statistic 
Lag[1]                      1.723  
Lag[2*(p+q)+(p+q)-1][5]     2.157  
Lag[4*(p+q)+(p+q)-1][9]     2.986  
d.o.f=2
- p-value:  = 0.002106
